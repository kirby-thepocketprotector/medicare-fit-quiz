...
export default function Q01Page() {
  ...
  useEffect(() => {
    ...
    router.prefetch('/ntm-quiz-2026-v2-leadform/q01a');
    router.prefetch('/ntm-quiz-2026-v2-leadform/q02');
  ...
  const handleContinue = () => {
    if (selectedMonth && selectedYear) {
      ...
      const nextRoute = isInIEP ? '/ntm-quiz-2026-v2-leadform/q01a' : '/ntm-quiz-2026-v2-leadform/q02';
          ...
          <div style={{ position: 'relative' }}>
            <select
              ...
              style={{
                ...
                padding: '20px',
                fontSize: '17px',
                color: selectedMonth ? '#1e293b' : '#9CA3AF',
          ...
          <div style={{ position: 'relative' }}>
            <select
              ...
              style={{
                ...
                padding: '20px',
                fontSize: '17px',
                color: selectedYear ? '#1e293b' : '#9CA3AF',
                backgroundColor: '#FFFFFF',
                border: '1px solid #E5E7EB',
                borderRadius: '16px',
                fontWeight: '400',
