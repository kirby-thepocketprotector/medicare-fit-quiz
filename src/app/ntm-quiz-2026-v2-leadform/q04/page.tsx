...
export default function Q04Page() {
  ...
  useEffect(() => {
    ...
    router.prefetch('/ntm-quiz-2026-v2-leadform/q05a');
    router.prefetch('/ntm-quiz-2026-v2-leadform/q05');
  ...
  const handleContinue = () => {
    ...
    // For Medicaid users, show budget stories before contact form
    const nextRoute = selected === true ? '/ntm-quiz-2026-v2-leadform/q05a' : '/ntm-quiz-2026-v2-leadform/q05';
