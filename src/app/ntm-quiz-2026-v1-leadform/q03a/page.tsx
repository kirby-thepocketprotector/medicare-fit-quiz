...
export default function Q03APage() {
  ...
  useEffect(() => {
    ...
    router.prefetch('/ntm-quiz-2026-v1-leadform/q03b');
    router.prefetch('/ntm-quiz-2026-v1-leadform/q04');
  }, []);
  ...
  const handleContinue = () => {
    ...
    const nextRoute = selected === true ? '/ntm-quiz-2026-v1-leadform/q03b' : '/ntm-quiz-2026-v1-leadform/q04';
