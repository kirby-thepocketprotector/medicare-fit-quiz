...
export default function Q02Page() {
  ...
  useEffect(() => {
    ...
    router.prefetch('/ntm-quiz-2026-v1-leadform/q02a');
    router.prefetch('/ntm-quiz-2026-v1-leadform/q03');
  }, []); // Empty deps to run only once on mount

  const handleSelect = (value: boolean) => {
    // Navigate immediately for instant response
    const nextRoute = value ? '/ntm-quiz-2026-v1-leadform/q02a' : '/ntm-quiz-2026-v1-leadform/q03';
